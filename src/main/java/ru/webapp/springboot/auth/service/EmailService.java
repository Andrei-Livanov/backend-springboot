...
public class EmailService {
    ...
    public Future<Boolean> sendActivationEmail(String email, String username, String uuid) {
        ...
        try {
            ...
            String htmlMsg = String.format("Здравствуйте.<br/><br/>" +
                    "Вы создали аккаунт для веб приложения \"Планировщик дел\": %s.<br/><br/>" +
                    "<a href='%s'>%s<a/><br/><br/>", username, url, "Для подтверждения регистрации" +
    ...
    public Future<Boolean> sendResetPasswordEmail(String email, String token) {
        ...
        try {
            ...
            String htmlMsg = String.format("Здравствуйте.<br/><br/>" +
                    ...
                    "Если это были не Вы - просто удалите это письмо.<br/><br/> Нажмите на ссылку ниже," +
                    " если хотите сбросить пароль: <br/><br/> " +
